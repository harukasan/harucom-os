...
# Frame pacing. In the browser the canvas blit and the VM share one thread. A
# render loop that commits every iteration (the p5 demos do this) would redraw
# far above 60fps and starve the rest of the page. So make commit suspend for a
# frame. Those loops then run at the display rate.
class << DVI::Graphics

...
//
// Bit order: MSB = leftmost pixel (bit 7 = col 0), matching dvi_font_t convention.
...
static const uint8_t font8x8_basic_bitmap[128 * 8] = {
...
static const dvi_font_t font8x8_basic = {
    .glyph_width  = 8,
    .glyph_height = 8,
    .first_char   = 0,
    .num_chars    = 128,
    .bitmap       = font8x8_basic_bitmap,
};

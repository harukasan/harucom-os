...
static const uint16_t sine_table[256] = {
  ...
  2831, 2877, 2923, 2968, 3012, 3056, 3100, 3143,
  ...
  3496, 3460, 3423, 3385, 3346, 3307, 3267, 3226,
  3185, 3143, 3100, 3056, 3012, 2968, 2923, 2877,
  2831, 2784, 2737, 2690, 2642, 2594, 2545, 2496,
  2447, 2398, 2348, 2298, 2248, 2198, 2148, 2098,
  2048, 1997, 1947, 1897, 1847, 1797, 1747, 1697,
  1648, 1599, 1550, 1501, 1453, 1405, 1358, 1311,
  1264, 1218, 1172, 1127, 1083, 1039,  995,  952,
   910,  869,  828,  788,  749,  710,  672,  635,
   599,  564,  530,  497,  465,  433,  403,  373,
   ...
   599,  635,  672,  710,  749,  788,  828,  869,
...
static const uint16_t pan_tab_l[16] = {
  4095, 4095, 4069, 3992, 3865, 3689, 3467, 3202,
  2896, 2553, 2179, 1777, 1352,  911,  458,    0
};
static const uint16_t pan_tab_r[16] = {
     0,    0,  458,  911, 1352, 1777, 2179, 2553,
                   ...
                   uint8_t waveform, uint8_t volume)
{
  ...
  ch->phase_increment = frequency
    ? (uint32_t)(((uint64_t)frequency << 32) / PWM_AUDIO_SAMPLE_RATE)
    : 0;
...
pwm_audio_fill_buffer(void)
{
  ...
  while ((pwm_audio_wr - pwm_audio_rd) < PWM_AUDIO_BUF_SIZE - 1) {
    ...
    pwm_audio_buf[pwm_audio_wr & PWM_AUDIO_BUF_MASK] =
      ((uint32_t)l << 16) | r;
    pwm_audio_wr++;
  }
}
